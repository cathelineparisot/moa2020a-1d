...
| 2  | Système de Ranking = classement                                                                  | | | | | X | | | 67/24 |
...
| 21 | Système de pari uniquement ARGENT réel                                                           | | | | | | | X | |
...
| 34 | Version premium meilleurs graphismes, personnalisations des dos de cartes                          | | | | | X | | | 69 |
| 35 | Version premium enlever des pubs (donc pubs sur la version gratuite)                             | | | | | X | | | 69 |
| 36 | Empêcher la triche dans le chat (limiter à avant/après la partie)                                | | X | | | | | | |
...
| 47 | Problème si deux personnes en local jouent ensemble                                              | | X | | | | | | |
...
| 51 | Monnaie virtuel pour le jeu, pour acheter des éléments dans le jeu (et pour le système de pari)  | | | | | X | | | 69 |
| 52 | Monnaie virtuel <=> Monnaie réelle                                                               | | | | | X | | | 69 |
| 53 | Prendre une commission sur la monnaie virtuelle                                                   | | | | | X | | | 69 |
